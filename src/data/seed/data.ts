...
export const seedData = {
  users: [
    { name: 'Test 1', userName: 'UserTest1', email: 'test1@google.com', password: BcryptAdapter.hash( '123456') },
    { name: 'Test 2', userName: 'UserTest2', email: 'test2@google.com', password: BcryptAdapter.hash( '123456') },
    { name: 'Test 3', userName: 'UserTest3', email: 'test3@google.com', password: BcryptAdapter.hash( '123456') },
    { name: 'Test 4', userName: 'UserTest4', email: 'test4@google.com', password: BcryptAdapter.hash( '123456') },
    { name: 'Test 5', userName: 'UserTest5', email: 'test5@google.com', password: BcryptAdapter.hash( '123456') },
    { name: 'Test 6', userName: 'UserTest6', email: 'test6@google.com', password: BcryptAdapter.hash( '123456') },
  ],
